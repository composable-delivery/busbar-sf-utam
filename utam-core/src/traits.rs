...
pub trait RootPageObject: PageObject {
    ...
    /// or the timeout is reached. This is useful for pages that may
    /// not be immediately available after navigation.
    ///
    /// # Arguments
    ///
    /// * `driver` - The WebDriver instance
    ...
    /// # Errors
    ///
    /// Can return errors if initialization requires additional operations
